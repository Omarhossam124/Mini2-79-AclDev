...
public interface TripRepository extends JpaRepository<Trip, Long> {
    ...
    @Query("SELECT t FROM Trip t WHERE t.captain.id = :captainId AND t.tripDate BETWEEN :startDate AND :endDate")
public List<Trip> findTripsByCaptainAndDateRange(Long captainId, LocalDateTime startDate, LocalDateTime endDate);
}